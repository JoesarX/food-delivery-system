...
//!DEPRECATED: This old version worked by bringing the categories we separated the products by, but now we are bringing all products
//! Left in the meantime to show how to fetch data from the API and filter it by category
//! It was moved from the /menu folder to the /menu/categories folder
