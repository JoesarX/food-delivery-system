...
const ContactPage = () => {
    return (
        ...
        <div className="p-4 h-[calc(100vh-153px)] md:h-[calc(100vh-14rem)] flex items-center justify-center text-blue-800">
            {/* BOX */}
            <div className=" h-full shadow-2xl rounded-md flex w-full flex-col md:flex-row md:h-[80%] lg:w-[80%] 2xl:w-[65%] ">
                {/* IMAGE CONTAINER */}
                <div className="relative h-1/5 w-full md:h-full md:w-1/2">
                    <Image src="/contactanosLosToneles.jpg" alt="" fill className="object-cover" />
                </div>
                {/* FORM CONTAINER */}
                <div className="p-4 pt-6 md:p-10 flex flex-col md:gap-5 gap-5 md:w-1/2 h-4/5 md:h-full ">
                    <h1 className="flex-1 font-bold text-3xl xl:text-4xl">Contactanos</h1>
                    <p className="flex-1 text-lg "><b>Telefono:</b> <span className="text-black">1234567890</span></p>
                    <span >
