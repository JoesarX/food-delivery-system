    ...
    return (
        ...
        <div className="p-4 h-[calc(100vh-6rem)] md:h-[calc(100vh-14rem)] flex items-center justify-center">
            ...
            <div className=" h-full shadow-2xl rounded-md flex w-full flex-col md:flex-row md:h-[80%] lg:w-[80%] 2xl:w-[65%] ">
                ...
                {/* FORM CONTAINER */}
                <div className="p-10 flex flex-col gap-8 md:w-1/2 h-[67%] md:h-full ">
                    <h1 className="font-bold text-3xl xl:text-4xl">Contactanos</h1>
                    <p className="text-lg"><b>Telefono:</b> 1234567890</p>
                    <span>
                        <p className="text-lg"><b>Horario de Atencion:</b></p>
                        <p className="text-lg">Lunes - Sabado: 10:00 am - 7:00 pm</p>
                    </span>
